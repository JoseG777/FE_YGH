  ...
  <div class="yugioh-realm">
    <div class="mystical-container">
      ...
      <div class="search-altar">
        <input type="text" v-model="name" placeholder="I call upon..." class="mystical-input" />
        ...
        <div v-if="succesful_search" class="card-revelation">
          ...
          <div class="card-lore">
            ...
            <div class="card-stats">
              ...
              <p
                ><span class="stat-label">ATK:</span> {{ atk || 'N/A' }}
                <span class="stat-label">DEF:</span> {{ def || 'N/A' }}</p
              >
              <p
                ><span class="stat-label">Level:</span> {{ level || 'N/A' }}
                <span class="stat-label">Type:</span> {{ type || 'Unknown' }}</p
              >
            </div>
            <button @click="saveImage" class="capture-button">Add to Collection</button>
          </div>
        </div>
      </transition>
    </div>
