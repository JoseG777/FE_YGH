    ...
    <body>
      <form class="login-form">
        <div class="field">
          ...
          <span
            class="placeholder"
            :class="{ 'placeholder-visible': showEmailPlaceholder }"
            >Email</span
          >
        </div>
        <div class="field">
          ...
          <span
            class="placeholder"
            :class="{ 'placeholder-visible': showPasswordPlaceholder }"
            >Password</span
          >
        </div>
        <div class="field">
          ...
          <span
            class="placeholder"
            :class="{ 'placeholder-visible': showConfirmPasswordPlaceholder }"
